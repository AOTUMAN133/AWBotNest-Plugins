...
// 插件前端 = 模块联邦「远程」。平台从 /api/plugins/my115sign/fe/assets/remoteEntry.js
// 动态 import，取 exposes 的 './Config' 挂进配置弹窗。vue 声明 shared+generate:false，
// 复用平台那份 Vue，不重复打包。base 用绝对挂载路径，避免子 chunk 相对 remoteEntry
// 解析多出一层 assets/ 导致 404。
export default defineConfig({
  base: '/api/plugins/my115sign/fe/',
  plugins: [
    vue(),
    federation({
      name: 'awbotnest_115sign',
