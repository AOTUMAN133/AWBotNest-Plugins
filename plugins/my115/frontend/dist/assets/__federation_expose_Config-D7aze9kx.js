...
const {normalizeClass:_normalizeClass,createElementVNode:_createElementVNode,vModelCheckbox:_vModelCheckbox,withDirectives:_withDirectives,vModelText:_vModelText,createTextVNode:_createTextVNode,toDisplayString:_toDisplayString,vShow:_vShow,openBlock:_openBlock,createElementBlock:_createElementBlock,createCommentVNode:_createCommentVNode,renderList:_renderList,Fragment:_Fragment} = await importShared('vue');
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    ...
    _withDirectives(_createElementVNode("div", _hoisted_35, [
      _createElementVNode("div", _hoisted_36, [
        ...
        _createElementVNode("span", _hoisted_37, _toDisplayString(logs.value.length) + " 条", 1)
      ]),
      (logs.value.length)
            ...
            _createElementVNode("tbody", null, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(logs.value, (l, i) => {
                return (_openBlock(), _createElementBlock("tr", { key: i }, [
                  _createElementVNode("td", _hoisted_39, _toDisplayString(l.time), 1),
        ...
        : (_openBlock(), _createElementBlock("div", _hoisted_40, "暂无处理记录"))
    ], 512), [
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-07bdf423"]]);
