...
const _hoisted_28 = { class: "row top" };
const _hoisted_29 = { class: "savebar" };
const _hoisted_30 = ["disabled"];
const _hoisted_31 = { class: "pane" };
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    ...
    _withDirectives(_createElementVNode("div", _hoisted_3, [
      ...
      _createElementVNode("section", _hoisted_27, [
        ...
        _createElementVNode("label", _hoisted_28, [
          _cache[38] || (_cache[38] = _createElementVNode("span", null, "排除类型", -1)),
          _withDirectives(_createElementVNode("textarea", {
            "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((cfg.exclude_genres) = $event)),
            class: "inp",
            rows: "2",
            placeholder: "填 TMDB 类型名，逗号分隔\n例如：动画, 动画片, Documentary\n匹配到任一类型则跳过不转发"
          }, null, 512), [
            [_vModelText, cfg.exclude_genres]
          ])
        ])
      ]),
    ...
    _withDirectives(_createElementVNode("div", _hoisted_37, [
      _createElementVNode("div", _hoisted_38, [
        ...
        _createElementVNode("span", _hoisted_39, _toDisplayString(logs.value.length) + " 条", 1)
      ]),
      (logs.value.length)
            ...
            _createElementVNode("tbody", null, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(logs.value, (l, i) => {
                return (_openBlock(), _createElementBlock("tr", { key: i }, [
                  _createElementVNode("td", _hoisted_41, _toDisplayString(l.time), 1),
        ...
        : (_openBlock(), _createElementBlock("div", _hoisted_42, "暂无处理记录"))
    ], 512), [
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-bf628b03"]]);
