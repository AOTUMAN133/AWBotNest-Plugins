...
const _hoisted_37 = { class: "row top" };
...
const _hoisted_47 = { class: "savebar" };
const _hoisted_48 = ["disabled"];
const _hoisted_49 = { class: "pane" };
const _hoisted_50 = { class: "toolbar" };
const _hoisted_51 = { class: "muted" };
...
const _hoisted_56 = { class: "mem-list" };
const _hoisted_57 = ["onClick"];
const _hoisted_58 = { class: "mem-h" };
const _hoisted_59 = { class: "mem-type" };
const _hoisted_60 = { class: "mem-id" };
const _hoisted_61 = { class: "mem-last" };
const _hoisted_62 = { class: "mem-meta" };
const _hoisted_63 = ["onClick"];
const _hoisted_64 = { class: "mem-detail" };
const _hoisted_65 = {
  key: 0,
  class: "muted center"
};
...
const _hoisted_68 = { class: "bubble-role" };
const _hoisted_69 = { class: "bubble-text" };
const _hoisted_70 = { class: "layout" };
const _hoisted_71 = { style: {"flex":"1","padding":"0 12px"} };
const _hoisted_72 = {
  key: 0,
  class: "muted",
  style: {"padding":"40px 0","text-align":"center"}
};
const _hoisted_73 = { class: "ts" };
const _hoisted_74 = { class: "msg" };
      ...
      : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
          ...
          _withDirectives(_createElementVNode("div", _hoisted_4, [
            _createElementVNode("aside", _hoisted_5, [
              _cache[29] || (_cache[29] = _createElementVNode("div", { class: "side-title" }, "设置分组", -1)),
            ...
            _createElementVNode("div", _hoisted_8, [
              (group.value === 'api')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    _cache[33] || (_cache[33] = _createElementVNode("h3", { class: "det-title" }, "OpenAI 兼容接口", -1)),
                    _createElementVNode("section", _hoisted_9, [
                      _createElementVNode("label", _hoisted_10, [
                        _cache[30] || (_cache[30] = _createElementVNode("span", null, "API Key", -1)),
                      ...
                      _createElementVNode("label", _hoisted_11, [
                        _cache[31] || (_cache[31] = _createElementVNode("span", null, "接口地址", -1)),
                        _withDirectives(_createElementVNode("input", {
                      ...
                      _createElementVNode("label", _hoisted_12, [
                        _cache[32] || (_cache[32] = _createElementVNode("span", null, "模型", -1)),
                        _withDirectives(_createElementVNode("input", {
                ...
                : (group.value === 'human')
                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                      _cache[42] || (_cache[42] = _createElementVNode("h3", { class: "det-title" }, "人形回复", -1)),
                      _createElementVNode("section", _hoisted_15, [
                        _createElementVNode("label", _hoisted_16, [
                          ...
                          _cache[34] || (_cache[34] = _createElementVNode("span", null, "私聊回复（私聊里直接对话）", -1))
                        ]),
                        _createElementVNode("label", _hoisted_17, [
                          ...
                          _cache[35] || (_cache[35] = _createElementVNode("span", null, "群聊回复（群里 @你 或回复你的消息时对话）", -1))
                        ]),
                        (cfg.enable_group_chat)
                          ? (_openBlock(), _createElementBlock("label", _hoisted_18, [
                              _cache[36] || (_cache[36] = _createElementVNode("span", null, "生效群组", -1)),
                        ...
                        _createElementVNode("label", _hoisted_19, [
                          _cache[37] || (_cache[37] = _createElementVNode("span", null, "人设", -1)),
                          _withDirectives(_createElementVNode("textarea", {
                        ...
                        _createElementVNode("label", _hoisted_20, [
                          _cache[38] || (_cache[38] = _createElementVNode("span", null, "记忆轮数", -1)),
                          _withDirectives(_createElementVNode("input", {
                          ...
                          _cache[39] || (_cache[39] = _createElementVNode("span", { class: "hint" }, "每会话保留多少条历史，0=不记忆", -1))
                        ]),
                        _createElementVNode("label", _hoisted_21, [
                          _cache[40] || (_cache[40] = _createElementVNode("span", null, "跟随窗口", -1)),
                          _withDirectives(_createElementVNode("input", {
                          ...
                          _cache[41] || (_cache[41] = _createElementVNode("span", { class: "hint" }, "@/回复后几分钟内跟随聊天，0=关闭", -1))
                        ])
                      ])
                    ], 64))
                  : (group.value === 'proactive')
                    ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                        _cache[50] || (_cache[50] = _createElementVNode("h3", { class: "det-title" }, "随机主动搭话", -1)),
                        _createElementVNode("section", _hoisted_22, [
                          _createElementVNode("label", _hoisted_23, [
                            ...
                            _cache[43] || (_cache[43] = _createElementVNode("span", null, "开启随机主动搭话", -1))
                          ]),
                          _cache[49] || (_cache[49] = _createElementVNode("p", { class: "tip" }, "在下方群组里每隔随机时间挑一条群友近期消息主动接话开启话题；群友回复你后走人形对话续聊（需「群聊回复」开着）。", -1)),
                          (cfg.enable_proactive)
                            ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                _createElementVNode("label", _hoisted_24, [
                                  _cache[44] || (_cache[44] = _createElementVNode("span", null, "搭话群组", -1)),
                                  _withDirectives(_createElementVNode("textarea", {
                                ...
                                _createElementVNode("div", _hoisted_25, [
                                  _createElementVNode("label", _hoisted_26, [
                                    _cache[45] || (_cache[45] = _createElementVNode("span", null, "间隔最小", -1)),
                                    _withDirectives(_createElementVNode("input", {
                                    ...
                                    _cache[46] || (_cache[46] = _createElementVNode("span", { class: "hint" }, "分钟", -1))
                                  ]),
                                  _createElementVNode("label", _hoisted_27, [
                                    _cache[47] || (_cache[47] = _createElementVNode("span", null, "间隔最大", -1)),
                                    _withDirectives(_createElementVNode("input", {
                                    ...
                                    _cache[48] || (_cache[48] = _createElementVNode("span", { class: "hint" }, "分钟", -1))
                                  ])
                                ])
                              ], 64))
                            : _createCommentVNode("", true)
                    ...
                    : (group.value === 'autosay')
                      ? (_openBlock(), _createElementBlock(_Fragment, { key: 3 }, [
                          _cache[62] || (_cache[62] = _createElementVNode("h3", { class: "det-title" }, "自动发言", -1)),
                          _createElementVNode("section", _hoisted_28, [
                            _createElementVNode("label", _hoisted_29, [
                              ...
                              _cache[51] || (_cache[51] = _createElementVNode("span", null, "开启定时自动发言", -1))
                            ]),
                            _createElementVNode("label", _hoisted_30, [
                              ...
                              _cache[52] || (_cache[52] = _createElementVNode("span", null, "答题奖励（自动回复机器人数学题）", -1))
                            ]),
                            (cfg.enable_reward_answer)
                              ? (_openBlock(), _createElementBlock("label", _hoisted_31, [
                                  _cache[53] || (_cache[53] = _createElementVNode("span", null, "指定机器人", -1)),
                                  _withDirectives(_createElementVNode("input", {
                              ...
                              : _createCommentVNode("", true),
                            _cache[61] || (_cache[61] = _createElementVNode("p", { class: "tip" }, "在下方群组里每隔随机时间随机选 2 条发言，间隔 3-8 秒。至少需要 2 条可选。", -1)),
                            (cfg.enable_auto_say)
                              ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                                  _createElementVNode("label", _hoisted_32, [
                                    _cache[54] || (_cache[54] = _createElementVNode("span", null, "发言群组", -1)),
                                    _withDirectives(_createElementVNode("textarea", {
                                  ...
                                  _createElementVNode("div", _hoisted_33, [
                                    _createElementVNode("label", _hoisted_34, [
                                      _cache[55] || (_cache[55] = _createElementVNode("span", null, "间隔最小", -1)),
                                      _withDirectives(_createElementVNode("input", {
                                      ...
                                      _cache[56] || (_cache[56] = _createElementVNode("span", { class: "hint" }, "分钟", -1))
                                    ]),
                                    _createElementVNode("label", _hoisted_35, [
                                      _cache[57] || (_cache[57] = _createElementVNode("span", null, "间隔最大", -1)),
                                      _withDirectives(_createElementVNode("input", {
                                      ...
                                      _cache[58] || (_cache[58] = _createElementVNode("span", { class: "hint" }, "分钟", -1))
                                    ])
                                  ]),
                                  _createElementVNode("label", _hoisted_36, [
                                    _withDirectives(_createElementVNode("input", {
                                      "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((cfg.auto_say_use_lyrics) = $event)),
                                      type: "checkbox"
                                    }, null, 512), [
                                      [_vModelCheckbox, cfg.auto_say_use_lyrics]
                                    ]),
                                    _cache[59] || (_cache[59] = _createElementVNode("span", null, "混入随机歌词（内置 300+ 条经典歌词）", -1))
                                  ]),
                                  _createElementVNode("label", _hoisted_37, [
                                    _cache[60] || (_cache[60] = _createElementVNode("span", null, "发言词条", -1)),
                                    _withDirectives(_createElementVNode("textarea", {
                                      "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((cfg.auto_say_phrases) = $event)),
                                      class: "inp",
                                      rows: "8",
                                  ...
                                  _createElementVNode("div", _hoisted_38, [
                                    _createElementVNode("button", {
                                      ...
                                      onClick: testAutoSay
                                    }, _toDisplayString(autoSaying.value ? '发言中…' : '🔘 测试发言'), 9, _hoisted_39)
                                  ])
                                ], 64))
                              : _createCommentVNode("", true)
                          ])
                      ...
                      : (group.value === 'sum')
                        ? (_openBlock(), _createElementBlock(_Fragment, { key: 4 }, [
                            _cache[63] || (_cache[63] = _createStaticVNode("<h3 class=\"det-title\" data-v-57589e62>群消息总结（.sum 命令）</h3><section class=\"card\" data-v-57589e62><p class=\"tip\" data-v-57589e62>在群聊中发送 <code data-v-57589e62>.sum 100</code> 快速总结最近消息，无需额外配置，复用 AI 接口配置。</p><div class=\"row-usage\" data-v-57589e62><code data-v-57589e62>.sum 100</code> — 总结最近100条 </div><div class=\"row-usage\" data-v-57589e62><code data-v-57589e62>.sum add 群组ID 2h 100</code> — 添加定时总结任务 </div><div class=\"row-usage\" data-v-57589e62><code data-v-57589e62>.sum list</code> — 查看所有任务 </div><div class=\"row-usage\" data-v-57589e62><code data-v-57589e62>.sum run 1</code> — 立即执行任务 </div><div class=\"row-usage\" data-v-57589e62><code data-v-57589e62>.sum del 1</code> — 删除任务 </div><div class=\"row-usage\" data-v-57589e62><code data-v-57589e62>.sum disable 1</code> — 禁用任务 </div><p class=\"tip\" style=\"margin-top:8px;\" data-v-57589e62>间隔格式: <code data-v-57589e62>2h</code>(2小时), <code data-v-57589e62>30m</code>(30分钟), 或 cron 表达式</p></section>", 2))
                          ], 64))
                        : (group.value === 'explain')
                          ? (_openBlock(), _createElementBlock(_Fragment, { key: 5 }, [
                              _cache[68] || (_cache[68] = _createElementVNode("h3", { class: "det-title" }, "/ai 解释命令", -1)),
                              _createElementVNode("section", _hoisted_40, [
                                _createElementVNode("label", _hoisted_41, [
                                  _withDirectives(_createElementVNode("input", {
                                    "onUpdate:modelValue": _cache[24] || (_cache[24] = $event => ((cfg.enable_explain_command) = $event)),
                                    type: "checkbox"
                                  }, null, 512), [
                                    [_vModelCheckbox, cfg.enable_explain_command]
                                  ]),
                                  _cache[64] || (_cache[64] = _createElementVNode("span", null, "启用 /ai 解释命令", -1))
                                ]),
                                _cache[67] || (_cache[67] = _createElementVNode("p", { class: "tip" }, "回复一条消息（或图片）再发 /ai，让 AI 解释/解答（单次，无记忆）。", -1)),
                                (cfg.enable_explain_command)
                                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                      _createElementVNode("label", _hoisted_42, [
                                        _withDirectives(_createElementVNode("input", {
                                          "onUpdate:modelValue": _cache[25] || (_cache[25] = $event => ((cfg.enable_explain_prompt) = $event)),
                                          type: "checkbox"
                                        }, null, 512), [
                                          [_vModelCheckbox, cfg.enable_explain_prompt]
                                        ]),
                                        _cache[65] || (_cache[65] = _createElementVNode("span", null, "用解释模板（否则直接把内容丢给 AI）", -1))
                                      ]),
                                      (cfg.enable_explain_prompt)
                                        ? (_openBlock(), _createElementBlock("label", _hoisted_43, [
                                            _cache[66] || (_cache[66] = _createElementVNode("span", null, "解释模板", -1)),
                                            _withDirectives(_createElementVNode("textarea", {
                                              "onUpdate:modelValue": _cache[26] || (_cache[26] = $event => ((cfg.explain_prompt) = $event)),
                                              class: "inp",
                                              rows: "6",
                          ...
                          : (group.value === 'scope')
                            ? (_openBlock(), _createElementBlock(_Fragment, { key: 6 }, [
                                _cache[71] || (_cache[71] = _createElementVNode("h3", { class: "det-title" }, "生效范围", -1)),
                                _createElementVNode("section", _hoisted_44, [
                                  _createElementVNode("label", _hoisted_45, [
                                    _cache[69] || (_cache[69] = _createElementVNode("span", null, "会话白名单", -1)),
                                    _withDirectives(_createElementVNode("textarea", {
                                      "onUpdate:modelValue": _cache[27] || (_cache[27] = $event => ((cfg.white_list_chats) = $event)),
                                      class: "inp",
                                      rows: "2",
                                  ...
                                  _createElementVNode("label", _hoisted_46, [
                                    _cache[70] || (_cache[70] = _createElementVNode("span", null, "群组黑名单", -1)),
                                    _withDirectives(_createElementVNode("textarea", {
                                      "onUpdate:modelValue": _cache[28] || (_cache[28] = $event => ((cfg.blacklist_chats) = $event)),
                                      class: "inp",
                                      rows: "2",
              ...
              _createElementVNode("div", _hoisted_47, [
                _createElementVNode("button", {
                  ...
                  onClick: save
                }, _toDisplayString(saving.value ? '保存中…' : '保存配置'), 9, _hoisted_48)
              ])
            ])
          ], 512), [
          ...
          _withDirectives(_createElementVNode("div", _hoisted_49, [
            _createElementVNode("div", _hoisted_50, [
              _createElementVNode("span", _hoisted_51, "下次主动搭话：" + _toDisplayString(proactiveNext.value || '—'), 1),
              _cache[72] || (_cache[72] = _createElementVNode("span", { class: "grow" }, null, -1)),
              _createElementVNode("button", {
                class: "btn",
            ...
            (histLoading.value)
              ? (_openBlock(), _createElementBlock("div", _hoisted_53, "加载中…"))
              : (!histories.value.length)
                ? (_openBlock(), _createElementBlock("div", _hoisted_54, [...(_cache[73] || (_cache[73] = [
                ...
                : (_openBlock(), _createElementBlock("div", _hoisted_55, [
                      ...
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(histories.value, (h) => {
                        return (_openBlock(), _createElementBlock("button", {
                          ...
                          _createElementVNode("div", _hoisted_58, [
                            _createElementVNode("span", _hoisted_59, _toDisplayString(h.is_private ? '私聊' : '群'), 1),
                            _createElementVNode("span", _hoisted_60, _toDisplayString(h.chat_id), 1)
                          ]),
                          _createElementVNode("div", _hoisted_61, _toDisplayString(h.last || '—'), 1),
                    ...
                    _createElementVNode("div", _hoisted_64, [
                      (!activeChat.value)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_65, "← 选择一个会话查看历史"))
                        : (msgLoading.value)
                          ? (_openBlock(), _createElementBlock("div", _hoisted_66, "加载中…"))
                          : (_openBlock(), _createElementBlock("div", _hoisted_67, [
                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(chatMessages.value, (m, i) => {
                                return (_openBlock(), _createElementBlock("div", {
                                  ...
                                  _createElementVNode("div", _hoisted_68, _toDisplayString(m.role === 'user' ? '对方' : '我'), 1),
                                  _createElementVNode("div", _hoisted_69, _toDisplayString(m.content), 1)
                                ], 2))
                              }), 128))
                            ]))
                    ])
          ...
          _withDirectives(_createElementVNode("div", _hoisted_70, [
            _createElementVNode("div", _hoisted_71, [
              (!debugLogs.value.length)
                ? (_openBlock(), _createElementBlock("div", _hoisted_72, "暂无日志"))
                : _createCommentVNode("", true),
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(debugLogs.value, (log) => {
                return (_openBlock(), _createElementBlock("div", {
                  ...
                  _createElementVNode("span", _hoisted_73, _toDisplayString(log.t), 1),
                  _createElementVNode("span", _hoisted_74, _toDisplayString(log.m), 1)
                ]))
              }), 128))
            ])
          ], 512), [
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-57589e62"]]);
