      ...
      : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                  ...
                  : (group.value === 'proactive')
                    ...
                    : (group.value === 'autosay')
                      ? (_openBlock(), _createElementBlock(_Fragment, { key: 3 }, [
                          _cache[60] || (_cache[60] = _createElementVNode("h3", { class: "det-title" }, "自动发言", -1)),
                            ...
                            (cfg.enable_auto_say)
                              ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [
                                  _createElementVNode("label", _hoisted_32, [
                                    ...
                                    _withDirectives(_createElementVNode("textarea", {
                                      "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((cfg.auto_say_chat_ids) = $event)),
                                      class: "inp",
                                      rows: "2",
                                      placeholder: "群ID逗号分隔，必填"
                                    }, null, 512), [
                                  ...
                                  _createElementVNode("div", _hoisted_33, [
                                    _createElementVNode("label", _hoisted_34, [
                                      ...
                                      _withDirectives(_createElementVNode("input", {
                                        "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((cfg.auto_say_min_minutes) = $event)),
                                        class: "inp sm",
                                        type: "number",
                                        min: "1",
                                        max: "120"
                                    ...
                                    _createElementVNode("label", _hoisted_35, [
                                      ...
                                      _withDirectives(_createElementVNode("input", {
                                        "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((cfg.auto_say_max_minutes) = $event)),
                                        class: "inp sm",
                                        type: "number",
                                        min: "1",
                                        max: "240"
                                  ...
                                  _createElementVNode("label", _hoisted_36, [
                                    _withDirectives(_createElementVNode("input", {
                                      "onUpdate:modelValue": _cache[21] || (_cache[21] = $event => ((cfg.auto_say_use_lyrics) = $event)),
                                      type: "checkbox"
                                    }, null, 512), [
                      ...
                      : (group.value === 'sum')
                        ...
                        : (group.value === 'explain')
                          ? (_openBlock(), _createElementBlock(_Fragment, { key: 5 }, [
                              _cache[66] || (_cache[66] = _createElementVNode("h3", { class: "det-title" }, "/ai 解释命令", -1)),
                              _createElementVNode("section", _hoisted_40, [
                                _createElementVNode("label", _hoisted_41, [
                                  ...
                                  _cache[62] || (_cache[62] = _createElementVNode("span", null, "启用 /ai 解释命令", -1))
                                ]),
                                _cache[65] || (_cache[65] = _createElementVNode("p", { class: "tip" }, "回复一条消息（或图片）再发 /ai，让 AI 解释/解答（单次，无记忆）。", -1)),
                                (cfg.enable_explain_command)
                                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                      _createElementVNode("label", _hoisted_42, [
                                        ...
                                        _cache[63] || (_cache[63] = _createElementVNode("span", null, "用解释模板（否则直接把内容丢给 AI）", -1))
                                      ]),
                                      (cfg.enable_explain_prompt)
                                        ? (_openBlock(), _createElementBlock("label", _hoisted_43, [
                                            _cache[64] || (_cache[64] = _createElementVNode("span", null, "解释模板", -1)),
                                            _withDirectives(_createElementVNode("textarea", {
                          ...
                          : (group.value === 'scope')
                            ? (_openBlock(), _createElementBlock(_Fragment, { key: 6 }, [
                                _cache[69] || (_cache[69] = _createElementVNode("h3", { class: "det-title" }, "生效范围", -1)),
                                _createElementVNode("section", _hoisted_44, [
                                  _createElementVNode("label", _hoisted_45, [
                                    _cache[67] || (_cache[67] = _createElementVNode("span", null, "会话白名单", -1)),
                                    _withDirectives(_createElementVNode("textarea", {
                                  ...
                                  _createElementVNode("label", _hoisted_46, [
                                    _cache[68] || (_cache[68] = _createElementVNode("span", null, "群组黑名单", -1)),
                                    _withDirectives(_createElementVNode("textarea", {
          ...
          _withDirectives(_createElementVNode("div", _hoisted_49, [
            _createElementVNode("div", _hoisted_50, [
              ...
              _cache[70] || (_cache[70] = _createElementVNode("span", { class: "grow" }, null, -1)),
              _createElementVNode("button", {
                class: "btn",
            ...
            (histLoading.value)
              ...
              : (!histories.value.length)
                ? (_openBlock(), _createElementBlock("div", _hoisted_54, [...(_cache[71] || (_cache[71] = [
