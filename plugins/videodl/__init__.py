...
__plugin__ = {
    ...
    "tags": ["视频下载", "聚合解析"],
    "scope": "user",
    "requirements": ["SignerPy>=0.12", "m3u8", "requests", "rich", "beautifulsoup4", "fake-useragent", "lxml", "platformdirs", "pathvalidate", "parsel", "tldextract", "bleach", "emoji", "filetype", "puremagic", "prettytable", "tqdm", "click", "gmssl", "pycryptodomex", "brotli", "cryptography", "pywidevine", "questionary", "json-repair"],
