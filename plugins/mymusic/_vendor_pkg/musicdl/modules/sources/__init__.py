...
class MusicClientBuilder(BaseModuleBuilder):
    REGISTERED_MODULES = {
        ...
        'YouTubeMusicClient': YouTubeMusicClient,        'JooxMusicClient': JooxMusicClient,                 'JamendoMusicClient': JamendoMusicClient,           'DeezerMusicClient': DeezerMusicClient,          'QobuzMusicClient': QobuzMusicClient,               
        'SpotifyMusicClient': SpotifyMusicClient,        'TIDALMusicClient': TIDALMusicClient,               'FMAMusicClient': FMAMusicClient,
